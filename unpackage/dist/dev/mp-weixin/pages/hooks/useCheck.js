...
function useCheck() {
  let account = common_vendor.reactive({
    username: "",
    password: "",
    email: "",
    createDateTime: ""
  });
  let tryPassword = common_vendor.ref("");
  let code = common_vendor.ref("");
  let inputCode = common_vendor.ref("");
  ...
  function isVaildPassword(password, tryagainPassword) {
  ...
  function isVaildCode(code2, inputCode2) {
    if (code2 == "outtime")
      return "验证码过期";
    if (inputCode2.length !== 6 || inputCode2 !== code2)
      return "验证码错误";
    return "success";
  }
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/hooks/useCheck.js.map
